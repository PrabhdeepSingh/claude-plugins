# SEO — worked examples and the llms.txt aside

Read the section matching what you're currently checking. The rules and their *why* live inline in `seo/SKILL.md`; this file is illustration plus one rarely-needed digression.
