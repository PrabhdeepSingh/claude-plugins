...
- Is the change idempotent by construction — nothing non-deterministic (a timestamp, an unpinned version, generated randomness) that would make a second apply show a diff?
