...
| **heartbeat** | Create, then timestamp-update **in place**, the one liveness comment a claimed pass maintains — never a second comment. Machine-read by liveness detection; a mutable pulse beside the immutable checkpoints. |
